...
abstract class Base
{
     ...
     * FastDFS数据包大小.
     */
    public const PROTO_PKG_LEN_SIZE = 8;

    /**
     * FastDFS头部大小.
     */
    public const HEADER_LENGTH = 10;

    /**
     * FastDFS IP地址长度.
     */
    public const IP_ADDRESS_SIZE = 16;
    public const FILE_EXT_NAME_MAX_LEN = 6;
    ...
    final public static function buildHeader($command, $length = 0)
    {
        return self::packU64($length).pack('Cx', $command);
    }

    final public static function buildMetaData($data)
    {
        $list = [];
    ...
    final public static function parseMetaData($data)
    {
     ...
     * @param mixed $v
     */
    final public static function unpackU64($v)
    {
